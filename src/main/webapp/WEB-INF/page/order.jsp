    ...
    <div class="row">
        <div class="col l2">
            <ul class="collection" id="left_order">
                <li ${param.status==null?"class='active light-blue darken-3'":"" }><a
                        href="${pageContext.request.contextPath}/order/getMyOrders">全部订单</a></li>
                <li ${param.status==0?"class='active light-blue darken-3'":"" }><a
                        href="${pageContext.request.contextPath}/order/getMyOrders?status=0">待付款订单</a></li>
                <li ${param.status==1?"class='active light-blue darken-3'":"" }><a
                        href="${pageContext.request.contextPath}/order/getMyOrders?status=1">待发货订单</a></li>
                <li ${param.status==4?"class='active light-blue darken-3'":"" }><a
                        href="${pageContext.request.contextPath}/order/getMyOrders?status=4">待收货订单</a></li>
                <li ${param.status==3?"class='active light-blue darken-3'":"" }><a
                        href="${pageContext.request.contextPath}/order/getMyOrders?status=3">已退款订单</a></li>
                <li ${param.status==8?"class='active light-blue darken-3'":"" }><a
                        href="${pageContext.request.contextPath}/order/getMyOrders?status=8">已退货订单</a></li>
                <li ${param.status==5?"class='active light-blue darken-3'":"" }><a
                        href="${pageContext.request.contextPath}/order/getMyOrders?status=5">交易成功订单</a></li>
                <li ${param.status==9?"class='active light-blue darken-3'":"" }><a
                        href="${pageContext.request.contextPath}/order/getMyOrders?status=9">交易关闭订单</a></li>
            </ul>
        </div>
                        ...
                        <table>
                            ...
                            <c:forEach items="${orderDetails}" var="od" varStatus="odvs">
                                <tr>
                                    ...
                                    <td>${od.odetailNum}</td>
                                    <td>${od.odetailPrice*od.odetailNum }
                            ...
                            <tr>
                                <td>
                                    <button class="light-blue darken-3 waves-effect waves-light btn" id="back" type="button"
                                            onclick="javascript:location.href='${pageContext.request.contextPath}/order/getOrderDetailById?orderId=${o.orderId}'">
                                        查看订单详情
                                    </button>
                                </td>
